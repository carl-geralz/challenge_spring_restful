...
public class AuthController {
    ...
    public ResponseEntity<CommonResponse<?>> registerUser(@RequestBody AuthRequest authRequest) {
        ...
        CommonResponse<RegisterResponse> response = CommonResponse.<RegisterResponse>builder().statusCode(HttpStatus.CREATED.value()).message(ConstantMessage.CREATED).data(registerResponse).build();
    ...
    public ResponseEntity<CommonResponse<?>> login(@RequestBody AuthRequest authRequest) {
        ...
        CommonResponse<LoginResponse> response = CommonResponse.<LoginResponse>builder().statusCode(HttpStatus.OK.value()).message(ConstantMessage.OK).data(loginResponse).build();
