...
public class CustomerController {
    ...
    @PostMapping
    public ResponseEntity<CommonResponse<Customer>> createCustomer(@RequestBody CustomerDTORequest customerDTORequest) {
        Customer createdCustomer = customerDAO.create(customerDTORequest);
